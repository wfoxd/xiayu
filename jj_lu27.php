...
$way = array("dl/jj_lu19.php","dl/jj_lu27.php","dl/jj_lu35.php","dl/jj_lu36.php");
area_now($way,$user_id);
//记录位置
include "../include/location_lu.inc.php";
up_location("荆棘路","dl/jj_lu27.php","$user_id");
?>
<?
	echo "<br>=============荆棘路===============<br>";
...
*/
	...
	<br>
	这里可以通往==><br>	
	<a href=./jj_lu35.php>【荆棘路】<a/>
	<a href=./jj_lu19.php>【荆棘路】<a/>
	<a href=./jj_lu36.php>【荆棘路】<a/>
	");
?>