...
$way = array("dl/jj_lu5.php","dl/jj_lu7.php","dl/jj_lu10.php","dl/jj_lu11.php");
area_now($way,$user_id);
//记录位置
include "../include/location_lu.inc.php";
up_location("荆棘路","dl/jj_lu7.php","$user_id");
?>
<?
	echo "<br>=============荆棘路===============<br>";
...
*/
	...
	<br>
	这里可以通往==><br>	
	<a href=./jj_lu11.php>【荆棘路】<a/>
	<a href=./jj_lu5.php>【荆棘路】<a/>
	<a href=./jj_lu10.php>【荆棘路】<a/>
	");
?>