...
$way = array("ereng/ereng_dong13.php","ereng/ereng_dong12.php");
area_now($way,$user_id);

include "../include/location_lu.inc.php";
up_location("洞内","ereng/ereng_dong13.php","$user_id");
?>
<?
	echo "<br>==============洞内岔路11==============<br>";
	echo ("
	...
	$bao_time = mysql_query("SELECT ereng_bao3 FROM ereng_bao");
	$bao_time = mysql_result($bao_time,0,"ereng_bao3");
	$now_time = time();
	...
	if(($now_time - $bao_time) > 7200){
		...
		mysql_query("UPDATE ereng_bao SET ereng_bao3='$now_time'");
		mysql_close();		
	}else{
	...
	<br>
	这里可以通往==><br>	
	<a href=./ereng_dong12.php>【洞内岔路10】<a/>
	");
?>