...
$way = array("dl/jj_lu33.php","dl/jj_lu39.php");
area_now($way,$user_id);
//记录位置
include "../include/location_lu.inc.php";
up_location("荆棘路","dl/jj_lu39.php","$user_id");
?>
<?
	echo "<br>=============荆棘路===============<br>";
	...
	$bao_time = mysql_query("SELECT bao3 FROM dl_bao");
	$bao_time = mysql_result($bao_time,0,"bao3");
	$now_time = time();
	...
	if(($now_time - $bao_time) > 11000){
		...
		mysql_query("UPDATE dl_bao SET bao3='$now_time'");
		mysql_close();		
	}else{
