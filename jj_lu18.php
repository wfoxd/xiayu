...
$way = array("dl/jj_lu14.php","dl/jj_lu18.php","dl/jj_lu24.php","dl/jj_lu25.php");
area_now($way,$user_id);
//记录位置
include "../include/location_lu.inc.php";
up_location("荆棘路","dl/jj_lu18.php","$user_id");
?>
<?
	echo "<br>=============荆棘路===============<br>";
...
*/
	...
	<br>
	这里可以通往==><br>	
	<a href=./jj_lu25.php>【荆棘路】<a/>
	<a href=./jj_lu14.php>【荆棘路】<a/>
