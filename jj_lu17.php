...
$way = array("dl/jj_lu13.php","dl/jj_lu17.php","dl/jj_lu22.php","dl/jj_lu23.php");
area_now($way,$user_id);
//记录位置
include "../include/location_lu.inc.php";
up_location("荆棘路","dl/jj_lu17.php","$user_id");
?>
<?
	echo "<br>=============荆棘路===============<br>";
...
*/
	...
	<br>
	这里可以通往==><br>	
	<a href=./jj_lu23.php>【荆棘路】<a/>
	<a href=./jj_lu13.php>【荆棘路】<a/>
	<a href=./jj_lu22.php>【荆棘路】<a/>
	");
?>