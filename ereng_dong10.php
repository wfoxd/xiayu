...
$way = array("ereng/ereng_dong9.php","ereng/ereng_dong10.php");
area_now($way,$user_id);

include "../include/location_lu.inc.php";
up_location("洞内","ereng/ereng_dong10.php","$user_id");
?>
<?
	echo "<br>==============洞内岔路8==============<br>";
	echo ("
	...
	$bao_time = mysql_query("SELECT ereng_bao2 FROM ereng_bao");
	$bao_time = mysql_result($bao_time,0,"ereng_bao2");
	$now_time = time();
	$my_info = mysql_query("SELECT yun FROM renwu_member WHERE id='$user_id'");
	$my_yun = mysql_result($my_info,0,"yun");
	$add_exp = $my_yun * 8 + 200;
	$add_mon = $my_yun * 4 + 100;
	
	if(($now_time - $bao_time) > 3600){
		echo ("
		...
		mysql_query("UPDATE ereng_bao SET ereng_bao2='$now_time'");
		mysql_close();		
	}else{
