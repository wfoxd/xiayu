...
$way = array("ereng/ereng_lu_r4.php","ereng/ereng_lu_r5.php","ereng/ereng_lu_r6.php");
area_now($way,$user_id);

include "../include/location_lu.inc.php";
up_location("恶人谷右路5","ereng/ereng_lu_r5.php","$user_id");
?>
<?
	echo "<br>==============恶人谷右路5==============<br>";
	...
	<br>
	这里可以通往==><br>	
	<a href=./ereng_lu_r4.php>【恶人谷右路4】<a/>
