...
<?
	...
	include "./inc/ereng_xiaohao.inc.php";	
    	...
    	if($my_exp < 150000){
    		echo ("
    			<br><br><font color=#4F88BB>你努力施展出平身所学，但还是无法通过这些石堆.....</font><br>
    		...
    		echo ("
    			...
    			<font color=#4F88BB>你施展平身所学，很轻易地跳过了石堆</font><br></p>
    		");
    	}
    	
    	include "../include/location_lu.inc.php";
	up_location("洞内","ereng/ereng_dong7.php","$user_id");
	echo ("
	<br>
	这里可以通往==><br>	
	<a href=./ereng_dong4.php>【洞内岔路2】<a/>
