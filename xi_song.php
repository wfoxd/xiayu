...
$way = array("xi_song.php","xy_city.php");
area_now($way,$user_id);
include "./include/location.inc.php";
up_location("西巷","xi_song.php","$user_id");
?>
<?
	echo "<br>==============西巷==============<br>";
	echo ("
		这是【侠域城】西边主要道路，从这里向前走可以出西门。
	");
    	$npc_org = "西巷";
		...
		if($my_song_to != ""){    		
    		if(($my_song_time - $now_time) > 0){
    			echo "<br><font color=#4DB39B>方仇对你说道：你的工作还没有完，你还要继续阿！</font><br><br>\n";	
    			mysql_close(); 
    		...
    		echo "<br><font color=#4DB39B>方仇对你说道：很好，既然你要帮我，那么请立刻出发在十五分钟内把这信送给：<font color=#D99631>".$npc_name."（".$npc_id."）</font></font>\n";	
    	...
    	echo "<br><font color=#4DB39B>方仇对你说道：我这里有个信件要送，你可以否给我帮忙？</font>\n";
    	echo "<br>你可以：<a href=xi_song.php?help=1>帮忙送信</a>\n";    
    	mysql_close(); 
    	include "./include/back_xy.inc.php";
?>